...
namespace ImmutableObjectGraph.Tests {
	...
	public abstract partial class ProjectElementContainer : ProjectElement, System.Collections.Generic.IEnumerable<ProjectElement>, IRecursiveParentWithOrderedChildren, IRecursiveParent<ProjectElement>, IRecursiveParentWithLookupTable<ProjectElement>, IRecursiveParentWithChildReplacement<ProjectElement> {
				...
				label: label)
		{
			...
			var lookupTableInitResult = RecursiveTypeExtensions.LookupTable<ProjectElement, ProjectElementContainer>.Initialize(this, lookupTable);
		...
		private System.Collections.Immutable.ImmutableDictionary<System.UInt32, System.Collections.Generic.KeyValuePair<ProjectElement, System.UInt32>> LookupTable {
			get {
				if (this.lookupTable == RecursiveTypeExtensions.LookupTable<ProjectElement, ProjectElementContainer>.LazySentinel) {
					this.lookupTable = RecursiveTypeExtensions.LookupTable<ProjectElement, ProjectElementContainer>.CreateLookupTable(this);
				}
		...
		uint IRecursiveParentWithLookupTable<ProjectElement>.InefficiencyLoad {
			get { return this.inefficiencyLoad; }
		}
		
		System.Collections.Generic.IReadOnlyCollection<ProjectElement> IRecursiveParentWithLookupTable<ProjectElement>.Children {
			get { return this.Children; }
		}
		
		System.Collections.Immutable.ImmutableDictionary<System.UInt32, System.Collections.Generic.KeyValuePair<ProjectElement, System.UInt32>> IRecursiveParentWithLookupTable<ProjectElement>.LookupTable {
		...
		public System.Collections.Immutable.ImmutableStack<ProjectElement> GetSpine(ProjectElement descendent) {
			return this.GetSpine<ProjectElementContainer, ProjectElement>(descendent);
		}
		
		public System.Collections.Immutable.ImmutableStack<ProjectElement> GetSpine(System.UInt32 identity) {
			return this.GetSpine<ProjectElementContainer, ProjectElement>(identity);
		}
		
		public ProjectElement Find(System.UInt32 identity)
		{
			return this.Find<ProjectElementContainer, ProjectElement>(identity);
		}
		
		public ProjectElementContainer GetParent(ProjectElement descendent) {
			return this.GetParent<ProjectElementContainer, ProjectElement>(descendent);
		}
		
		public ParentedRecursiveType<ProjectElementContainer, ProjectElement> GetParentedNode(System.UInt32 identity) {
			return this.GetParentedNode<ProjectElementContainer, ProjectElement>(identity);
		}
		
		IRecursiveParent<ProjectElement> IRecursiveParentWithChildReplacement<ProjectElement>.ReplaceChild(System.Collections.Immutable.ImmutableStack<ProjectElement> oldSpine, System.Collections.Immutable.ImmutableStack<ProjectElement> newSpine) {
			var newChildren = this.Children.Replace(oldSpine.Peek(), newSpine.Peek());
			var newSelf = this.WithChildren(newChildren);
		
			var lookupTableLazySentinel = RecursiveTypeExtensions.LookupTable<ProjectElement, ProjectElementContainer>.LazySentinel;
			if (newSelf.lookupTable == lookupTableLazySentinel && this.lookupTable != null && this.lookupTable != lookupTableLazySentinel) {
				...
				newSelf.lookupTable = RecursiveTypeExtensions.LookupTable<ProjectElement, ProjectElementContainer>.Fixup(this, ImmutableDeque.Create(newSpine), ImmutableDeque.Create(oldSpine));
				RecursiveTypeExtensions.LookupTable<ProjectElement, ProjectElementContainer>.ValidateInternalIntegrityDebugOnly(newSelf);
			}
