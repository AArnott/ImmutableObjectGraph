	...
	public partial class XmlElement : XmlNode, System.Collections.Generic.IEnumerable<XmlNode>, IRecursiveParentWithOrderedChildren, IRecursiveParentWithFastLookup {
		...
		bool IRecursiveParentWithFastLookup.TryLookup(int identity, out System.Collections.Generic.KeyValuePair<IRecursiveType, int> result) {
			if (this.LookupTable != null) {
				System.Collections.Generic.KeyValuePair<XmlNode, System.Int32> typedResult;
		...
		internal ParentedRecursiveType<XmlElement, XmlNode> GetParentedNode(System.Int32 identity) {
			...
			if (this.LookupTable != null) {
				...
				if (this.LookupTable.TryGetValue(identity, out lookupValue)) {
					...
					return new ParentedRecursiveType<XmlElement, XmlNode>(this.LookupTable[identity].Key, (XmlElement)this.Find(parentIdentity));
				}
			} else {
