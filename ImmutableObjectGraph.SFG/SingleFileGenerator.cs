    ...
    public class SingleFileGenerator : IVsSingleFileGenerator
    {
        ...
        public int Generate(string inputFilePath, string inputFileContents, string defaultNamespace, IntPtr[] outputFileContents, out uint outputLength, IVsGeneratorProgress generateProgress)
        {
            ...
            try
            {
                ...
                int docInProject;
                ErrorHandler.ThrowOnFailure(shellDocuments.IsDocumentInAProject(inputFilePath, out uiHierarchy, out itemid, out sp, out docInProject));
                var project = uiHierarchy as IVsProject;
                ...
                string generated = string.Format("// This was generated by a tool for the {0} project.", projectNameObject);
